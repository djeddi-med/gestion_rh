...
<div id="modal-mise_en_demeure" class="fixed inset-0 z-50 hidden flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden transform transition-all duration-300 scale-95 opacity-0">
        ...
        <div class="flex items-center justify-between p-6 border-b border-gray-200 bg-gradient-to-r from-red-600 to-red-700 text-white">
            <div class="flex items-center space-x-3">
                ...
                <h2 class="text-xl font-bold">Mise en Demeure</h2>
            </div>
        ...
        <div class="p-6 overflow-y-auto max-h-[70vh]">
            <div class="text-center py-8">
                ...
                <p class="text-gray-500 text-lg">Interface de mise en demeure à développer</p>
            </div>
        </div>
    </div>
</div>